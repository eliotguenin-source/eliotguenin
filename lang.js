...
(function(){
  const translations = {
    en: {
      ...
      recording_numb: 'Numb(er) Piece — Recording',
      recording_iterations: 'ITERATIONS — Recording',
      recording_petite: 'Petite pièce — Recording',
      work_dualis_title: 'DUALIS — For Cello Solo (2025)',
      work_esquisse_title: 'Esquisse — for a bowless cellist (finished?)',
      work_conducteur_title: 'Conducteur — Numb(er) Piece',
      work_iterations_title: 'ITERATIONS — EMERGENCES',
      work_petite_title: 'Petite pièce pour Piano — A ma soeur Nine',
      download_esquisse: 'Download Esquisse (PDF)',
      download_conducteur_pdf: 'Download Numb(er) Piece (PDF)',
      download_conducteur_mp3: 'Download MP3',
      download_iterations_pdf: 'Download ITERATIONS (PDF)',
      download_iterations_mp3: 'Download MP3',
      download_petite_pdf: 'Download Petite pièce (PDF)',
      download_petite_mp3: 'Download MP3',
      ...
      research_text: 'This research explores sonic biopolitics, streaming culture, and the subjectivation of listening in the Capitalocene.',
      research_pdf_label: 'Research_Project_GUENIN_Eliot.pdf',
      ...
      contact_intro: "If you'd like to get in touch, fill out the form below or email me directly.",
      contact_other_ways: 'Other ways to reach me',
      contact_linkedin: 'Eliot Guenin - LinkedIn Profile',
    ...
    fr: {
      ...
      recording_numb: 'Enregistrement — Numb(er) Piece',
      recording_iterations: 'Enregistrement — ITERATIONS',
      recording_petite: 'Enregistrement — Petite pièce',
      work_dualis_title: 'DUALIS — Pour Violoncelle seul (2025)',
      work_esquisse_title: 'Esquisse — pour un violoncelliste sans archet (terminée ?)',
      work_conducteur_title: 'Conducteur — Numb(er) Piece',
      work_iterations_title: 'ITERATIONS — EMERGENCES',
      work_petite_title: 'Petite pièce pour Piano — À ma sœur Nine',
      download_esquisse: 'Télécharger Esquisse (PDF)',
      download_conducteur_pdf: 'Télécharger Numb(er) Piece (PDF)',
      download_conducteur_mp3: 'Télécharger MP3',
      download_iterations_pdf: 'Télécharger ITERATIONS (PDF)',
      download_iterations_mp3: 'Télécharger MP3',
      download_petite_pdf: 'Télécharger Petite pièce (PDF)',
      download_petite_mp3: 'Télécharger MP3',
      contact_heading: 'Contact',
      about_heading: 'À propos',
      works_heading: 'Œuvres',
      research_heading: 'Recherches',
      research_text: 'Cette recherche explore la biopolitique du son, la culture du streaming et la subjectivation de l’écoute dans le capitalocène.',
      research_pdf_label: 'Projet_de_Recherche_GUENIN_Eliot.pdf',
      works_text: 'Toutes les partitions et les enregistrements joints ici sont libres d’utilisation et de téléchargement.',
      ...
      form_message: 'Message',
      form_submit: 'Envoyer',
      contact_intro: 'Si vous souhaitez me contacter, remplissez le formulaire ci-dessous ou envoyez-moi un email directement.',
      contact_other_ways: 'Autres moyens de me contacter',
      contact_linkedin: 'Eliot Guenin - Profil LinkedIn',
